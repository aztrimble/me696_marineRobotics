 ...
 */
class KanaloaCompressedImagePublisher implements KanaloaRawImageListener {
  ...
  public KanaloaCompressedImagePublisher(ConnectedNode connectedNode) {
    this.connectedNode = connectedNode;
    NameResolver resolver = connectedNode.getResolver().newChild(connectedNode.getName()+"/camera");
    imagePublisher =
