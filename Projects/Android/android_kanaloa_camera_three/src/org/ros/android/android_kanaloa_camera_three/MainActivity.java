...
public class MainActivity extends RosActivity {
  ...
  private KanaloaRosCameraPreviewView rosCameraPreviewView;

  public MainActivity() {
    super("Kanaloa Camera Three", "Kanaloa Camera Three");
  }
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    rosCameraPreviewView = (KanaloaRosCameraPreviewView) findViewById(R.id.ros_camera_preview_view);
    rosCameraPreviewView.setNodeName("kanaloa/android_three/");
  }

  @Override
  public boolean onTouchEvent(MotionEvent event) {
    // something is wrong with this function
    // returning true here to that it does not crash the app
    //if (event.getAction() == MotionEvent.ACTION_UP) {
    if (event.getAction() == -1000) {
