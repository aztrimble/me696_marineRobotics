 ...
 */
public class KanaloaCameraPreviewView extends ViewGroup {
  ...
  private KanaloaRawImageListener rawImageListener;
  ...
  private final class BufferingPreviewCallback implements PreviewCallback {
    ...
    public void onPreviewFrame(byte[] data, Camera camera) {
      Preconditions.checkArgument(camera == KanaloaCameraPreviewView.this.camera);
  ...
  public KanaloaCameraPreviewView(Context context) {
    super(context);
    init(context);
  }

  public KanaloaCameraPreviewView(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(context);
  }

  public KanaloaCameraPreviewView(Context context, AttributeSet attrs, int defStyle) {
  ...
  public void setRawImageListener(KanaloaRawImageListener rawImageListener) {
